...
class NearEarthObject:
    ...
    def __str__(self):
        ...
        if self.hazardous == True:
            return "NEO {} has a diameter of {} km and is potentially hazardous."\
            .format(self.fullname,self.diameter)
        else:
            return "NEO {} has a diameter of {} km and is not potentially hazardous."\
            .format(self.fullname,self.diameter)
